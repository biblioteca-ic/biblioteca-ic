...
const makeCreateUserValidation = (): Validation => {
  ...
  for (const field of ['name', 'email', 'registration_number', 'cpf', 'password', 'passwordConfirmation']) {
    validations.push(new RequiredFieldValidator(field))
  }
  validations.push(new EmailValidator('email', new EmailValidatorAdapter()))
  validations.push(new RegistrationNumberValidator('registration_number'))
