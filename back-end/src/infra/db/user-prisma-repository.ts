...
import { ListUsersRepository } from '../../data/protocols/users/list-users.repository'
...
export class UserPrismaRepository implements LoadUserByCpfRepository, UpdateUserByIdRepository, LoadUserByIdRepository, CreateUserRepository, ListUsersRepository, LoadUserByEmailRepository, LoadUserByRegisterNumberepository {
